            ...
            if (user != null)
            {
                if(user.IsVerified.HasValue)
                {
                    if (user.IsVerified.Value)
                    {
                        ...
                        {
                            AddRecipientAndTemplate(TemplateName.Welcome, recipientUserId.Value);
                        }
                        else
                        {
                            AddRecipientAndTemplate(TemplateName.ThanksForVerifying, recipientUserId.Value);
                        }
                    }
                    else
                    {
                        ...
                        {
                            AddRecipientAndTemplate(TemplateName.UnableToVerify, recipientUserId.Value);
                        }
                    }
                }   
            }
